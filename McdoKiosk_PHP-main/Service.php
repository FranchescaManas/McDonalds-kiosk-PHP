...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <!-- <a href="SelectedService.php"><button type="button" name="tableservice">Table Service</button></a> -->

            <form  method="post" action="./SelectedService.php">
                      <button type="submit" name="table">Table Service</button>
                      <button type="submit"  name="collect">I'll Collect By Myself</button>
            </form>
